...
public class ConnectionController {
    ...
    public String getGeoFencingDetails() throws Exception {
        ...
        try {
            String selectUSC = "SELECT E.EVENTNAME, L.LATITUDE, L.LONGITUDE FROM EVENT E INNER JOIN LOCATION L ON E.LOCATIONID=L.LOCATIONID WHERE E.EVENTDATE=((SELECT NOW() AT TIME ZONE 'PST') ::timestamp::date) AND\n" +
                    "E.ENDTIME>=(SELECT ((SELECT NOW() AT TIME ZONE 'PST') ::timestamp::time))";
